...
namespace SimpleGameEngine {
	...
	inline
	StrView enumStr(RenderDataType v) {
		switch (v) {
#define E(V) case RenderDataType::V: return #V;
		E(None)
...
#undef E
	...
	inline
	bool enumTryParse(RenderDataType& outValue, StrView str) {
#define E(V) if (str == #V) { outValue = RenderDataType::V; return true; }
		E(None)
...
#undef E
	...
	SGE_FORMATTER_ENUM(RenderDataType)
}
