...
constexpr u16 ColorType_make(ColorModel model, ColorElementType elem) {
	return static_cast<u16>((static_cast<u32>(model) << 8) | (static_cast<u32>(elem)));
}

constexpr u16 ColorType_make(ColorModel model, ColorCompressType compress) {
	return static_cast<u16>((static_cast<u32>(model) << 8) | (static_cast<u32>(compress)));
}
...
struct ColorR {
	...
	static constexpr ColorType kColorType = static_cast<ColorType>(ColorType_make(ColorModel::R, ColorElementType_get<T>()));
...
struct ColorRG {
	...
	static constexpr int kAlphaBits = 0;
	static constexpr ColorType kColorType = static_cast<ColorType>(ColorType_make(ColorModel::RG, ColorElementType_get<T>()));
...
struct ColorRGB {
	...
	static constexpr int kAlphaBits = 0;
	static constexpr ColorType kColorType = static_cast<ColorType>(ColorType_make(ColorModel::RGB, ColorElementType_get<T>()));
...
struct ColorRGBA {
	...
	static constexpr ColorType kColorType = static_cast<ColorType>(ColorType_make(ColorModel::RGBA, ColorElementType_get<T>()));
...
struct ColorL {
	...
	static const size_t kElementCount = 1;
	static constexpr int kAlphaBits = 0;
	static constexpr ColorType kColorType = static_cast<ColorType>(ColorType_make(ColorModel::L, ColorElementType_get<T>()));
...
struct ColorLA {
	...
	static const size_t kElementCount = 2;
	static constexpr int kAlphaBits = sizeof(T) * 8;
	static constexpr ColorType kColorType = static_cast<ColorType>(ColorType_make(ColorModel::LA, ColorElementType_get<T>()));
	...
	ColorLA() = default;
	ColorLA(const T& l_, const T& a_) : l(l_), a(a_) {}
};
